...
<table Border=0 CellSpacing=0 CellPadding=0 width=100%>
  <tr><td  class=pageline>
     <div class=wmiddletext><a href="main.php">Администрирование сайта</a> &#187; <?echo"$page_name";?></a></div>
  </td>
...
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0>
 <tr class=normaltext>
  <td ><div ><h4> SEO-информация<a href="mailto:"></a> </h4></div></td>
  <td align=right>  </td>
 </tr>
</table>
...
<table Border=0 CellSpacing=0 CellPadding=0 width=650>
 ...
 <tr>
  ...
  <table Border=0 CellSpacing=0 CellPadding=0>
   <tr><td class=lmenutext colspan=5><a>Заголовок (title) [<?=$langname;?>] :</a><br>
       <textarea name='static_seo_title' style="width:630px;" rows=2><?=$static_seo_title;?></textarea><p>
     </td></tr>

     <tr><td height=5></td></tr>

     <tr><td class=lmenutext colspan=5><a>Описание  (description) [<?=$langname;?>] :</a><br>
       <textarea name='static_seo_desc' style="width:630px;" rows=5><?=$static_seo_desc;?></textarea><p>
     </td></tr>

     <tr><td class=lmenutext colspan=5><a>Ключевые слова (keywords) [<?=$langname;?>] :</a><br>
