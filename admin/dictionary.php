...
{
if (confirm('Вы уверены, что хотите удалить фразу"?'))
 {
    document.data.oper.value=a;
    document.data.submit();
 }
...
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0 >
 <tr class=normaltext>
  ...
  <td align=right class=wmiddletext><a class=submenu onclick="Send(I)">добавить фразу</a></td>
 </tr>
</table>
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0 >
 <tr><td class=lmenutext height=30 bgcolor=#ffffff align="center">ФРАЗЫ СЛОВАРЯ</td></tr>
</table>
...
<table Border=0 CellSpacing=1 class=bluetable CellPadding=4 width=100%>
  <tr class=lmenutext height=20 align=center bgcolor=#ffffff>
    <td width=20>&nbsp;</td>
    <td width=40><?=SortTitle("Код","essence_code",$sortby,$sortdir);?></td>
    <?php
      for ($i=0;$i<$langcnt;$i++)
